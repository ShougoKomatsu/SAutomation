...
#define COMMAND_DELAY_FUNCTION (COMMAND_COMMON + 2)
...
#define COMMAND_SET_WINDOW_ATTRIBUTE (COMMAND_COMMON + 23)
#define COMMAND_SEND_MESSAGE (COMMAND_COMMON + 24)
#define COMMAND_PLAY_SOUND (COMMAND_COMMON + 25)
#define COMMAND_KILL (COMMAND_COMMON + 26)
...
#define COMMAND_VARIABLE_CLIPBOARD (COMMAND_VARIABLE+10)
#define COMMAND_VARIABLE_CAMERA (COMMAND_VARIABLE+11)
