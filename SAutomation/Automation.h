...
#define RETURN_FLOW (100)
#define RETURN_LABEL (RETURN_FLOW+1)
#define RETURN_GOTO (RETURN_FLOW+2)
#define RETURN_GOTO_BY_SWITCH (RETURN_FLOW+3)
#define RETURN_CALL_SUB (RETURN_FLOW+4)
#define RETURN_END_SUB (RETURN_FLOW+5)
#define RETURN_SUB (RETURN_FLOW+6)
