...
#define COMMAND_MOUSE_MOVE_INCL (COMMAND_MOUSE+2)
#define COMMAND_MOUSE_MOVE_TO_IMG (COMMAND_MOUSE+3)
#define COMMAND_MOUSE_SET_ORIGIN_TO_WINDOW (COMMAND_MOUSE+4)
#define COMMAND_MOUSE_SET_ORIGIN_TO_IMAGE (COMMAND_MOUSE+5)
#define COMMAND_MOUSE_MOVE_TO_ITEM (COMMAND_MOUSE+6)

#define COMMAND_WHEEL (COMMAND_MOUSE+7)

#define COMMAND_MOUSE_L_DOWN (COMMAND_MOUSE+100+1)
#define COMMAND_MOUSE_R_DOWN (COMMAND_MOUSE+100+2)
#define COMMAND_MOUSE_M_DOWN (COMMAND_MOUSE+100+3)

#define COMMAND_MOUSE_L_UP (COMMAND_MOUSE+100+4)
#define COMMAND_MOUSE_R_UP (COMMAND_MOUSE+100+5)
#define COMMAND_MOUSE_M_UP (COMMAND_MOUSE+100+6)


#define COMMAND_MOUSE_L_CLICK (COMMAND_MOUSE+100+7)
#define COMMAND_MOUSE_R_CLICK (COMMAND_MOUSE+100+8)
#define COMMAND_MOUSE_M_CLICK (COMMAND_MOUSE+100+9)

#define COMMAND_MOUSE_L_CLICK_IMG (COMMAND_MOUSE+100+10)
#define COMMAND_MOUSE_R_CLICK_IMG (COMMAND_MOUSE+100+11)
#define COMMAND_MOUSE_M_CLICK_IMG (COMMAND_MOUSE+100+12)

#define COMMAND_MOUSE_L_REPEATCLICK (COMMAND_MOUSE+100+13)
#define COMMAND_MOUSE_R_REPEATCLICK (COMMAND_MOUSE+100+14)
#define COMMAND_MOUSE_M_REPEATCLICK (COMMAND_MOUSE+100+15)

#define COMMAND_MOUSE_L_DRAG_AND_DROP (COMMAND_MOUSE+100+16)
#define COMMAND_MOUSE_R_DRAG_AND_DROP (COMMAND_MOUSE+100+17)
#define COMMAND_MOUSE_M_DRAG_AND_DROP (COMMAND_MOUSE+100+18)
